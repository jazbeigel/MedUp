...
export default class EspecialidadesRepository {
    constructor() {
        ...
        console.log('EspecialidadesRepository.constructor()');
        this.DBPool     = null;
    }
    ...
    getAllAsync = async () => {
        console.log(`EspecialidadesRepository.getAllAsync()`);
    ...
    getByIdAsync = async (id) => {
        console.log(`EspecialidadesRepository.getByIdAsync(${id})`);
        let returnEntity = null;
        try {
            const sql = `SELECT * FROM Especialidades WHERE id=$1`;
            const values = [id];
